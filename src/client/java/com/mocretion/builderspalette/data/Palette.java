...
public class Palette {
    ...
    public void getPaletteItemFromInventory(PlayerEntity player){
        ...
        int randomWeight = BuildersPaletteClient.random.nextBetween(1, totalWeight);
        totalWeight = 0;
        ...
        int randomBlock = BuildersPaletteClient.random.nextBetween(0, selectedWeightCat.getItems().size() - 1);
