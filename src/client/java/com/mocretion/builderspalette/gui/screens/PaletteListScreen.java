...
import com.mocretion.builderspalette.gui.draw.CustomDrawContext;
...
public class PaletteListScreen extends Screen {
    private static final Identifier BG_TEXTURE = Identifier.of(BuildersPaletteClient.MOD_ID, "textures/gui/palette_list.png");
    private static final Identifier PALETTE_PREVIEW_TEXTURE = Identifier.of(BuildersPaletteClient.MOD_ID, "textures/gui/palette_preview.png");
    private static final Identifier ADD_PALETTE_TEXTURE = Identifier.of(BuildersPaletteClient.MOD_ID, "textures/gui/add_palette.png");
    ...
    public PaletteListScreen(MinecraftClient client) {
        super(Text.translatable("container.builderspalette.palette_list"));
        this.client = client;
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (int paletteNo = scrollLevel; paletteNo < scrollLevel + 4; paletteNo++) {
            ...
            if(paletteNo == PaletteManager.getBuilderPalettes().size()){  // Add new element
                ...
                if(isPointInRegion(xPos, yPos, paletteItemWidth, paletteItemHeight, mouseX, mouseY)){
                    context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.addPalette"), mouseX, mouseY);
                }
                ...
                if(isPointInRegion(xPos + paletteEditMarginX, yPos + paletteEditMarginY, ButtonCatalogue.smallButtonSize, ButtonCatalogue.smallButtonSize, (int)mouseX, (int)mouseY)) {
                    ...
                    context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.editPalette"), mouseX, mouseY);
                    ...
                    context.drawTexture(PALETTE_PREVIEW_TEXTURE, xPos, yPos, 0, paletteItemHeight, paletteItemWidth, paletteItemHeight);
                    context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.deletePalette"), mouseX, mouseY);
                }  // Draw delete hover
                    ...
                    context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.selectHotbarSlot"), mouseX, mouseY);
                }
                // Draw hover texture
        ...
        if(isPointInRegion(leftPos + paletteToggleEnabledMarginX, topPos + paletteButtonMarginY, ButtonCatalogue.smallButtonSize, ButtonCatalogue.smallButtonSize, (int)mouseX, (int)mouseY)){
            ...
            context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.togglePalettes"), mouseX, mouseY);
            ...
            context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.deselectPalettes"), mouseX, mouseY);
        }  // Import palette
            ...
            context.drawTooltip(this.textRenderer, Text.translatable("container.builderspalette.importPalette"), mouseX, mouseY);
        }
    }
